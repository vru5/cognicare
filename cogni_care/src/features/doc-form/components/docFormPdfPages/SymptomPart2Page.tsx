  ...
  return (
    <div className="report-page">
      <PageShell pageNum={pageNum} totalPages={totalPages} patient={patient}>
        <DocFormHeader title={`${DOC_FORM_STRINGS.GENERAL.DOC_FORM_TITLE} — ${DOC_FORM_STRINGS.SYMPTOMS.REPORT_PART_2}`} patient={mergedPatient} />

        <div style={{ margin: "18px 40px 0" }}>
          <div style={{ fontSize: 13, fontWeight: 800, color: "#1a1a2e", marginBottom: 4 }}>{DOC_FORM_STRINGS.SYMPTOMS.SECTION_TITLE} — {DOC_FORM_STRINGS.GENERAL.PART_2}</div>
          <div style={{ fontSize: 11, color: "#999", marginBottom: 10 }}>{DOC_FORM_STRINGS.SYMPTOMS.CONTINUED_FROM}</div>
