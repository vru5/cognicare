...
export const CALCULATION_TEXT = {
  ...
  PREDICTIVE: {
    TITLE: "Health Prediction Logic",
    SUBTITLE: "How our AI generates your 7-day outlook.",
    LOGIC: "The health forecast is generated by a clinical-grade AI model that analyzes your patient's trajectory across three dimensions:",
    RULES: [
      {
        id: 1,
        title: "30-Day Historical Window",
        desc: "The AI analyzes every symptom log from the last 30 days. This long-term view allows it to distinguish between temporary 'bad days' and meaningful clinical trends."
      },
      {
        id: 2,
        title: "Pillar Correlation",
        desc: "It identifies how different pillars affect each other—for example, how poor Sleep (Pillar 4) might be driving a decline in Mood (Pillar 2) two days later."
      },
      {
        id: 3,
        title: "Proactive Forecasting",
        desc: "Based on these identified patterns, the model projects the most likely health trajectory for the next 7 days, highlighting specific 'Watchlist' items for carers to monitor."
      }
    ]
  }
};
